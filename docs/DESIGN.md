...
> Design notes for **property-nightly-snapshot-python** — a runnable python example that Python nightly snapshot of property-management records into object storage.
...
- **Feature code** — the actual task: property-nightly-backup.
